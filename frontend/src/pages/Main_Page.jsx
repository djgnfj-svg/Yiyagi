...
function Main_Page() {
    return (
        <>
            <section class="py-12 flex items-center mt-20 min-h-0.5 justify-center bg-white">
            ...
            <section class="flex items-center flex-1">
                <div class="flex flex-col w-full mt-20">
                    ...
                    <p class="mb-16 mt-8 text-center text-gray-700 dark:text-white text-md md:text-xl">Notify me when App is launched :)</p>
                </div>
            </section>
